...
export class NoizyEmpirePanel {
  static current?: vscode.WebviewPanel;
  ...
  static show(ctx: vscode.ExtensionContext) {
    ...
    panel.webview.onDidReceiveMessage(async msg => {
      switch (msg.cmd) {
        case 'turbo': await vscode.commands.executeCommand('noizybeast.' + msg.t.toLowerCase()); break;
        case 'navigate': await vscode.commands.executeCommand('noizybeast.' + msg.screen); break;
