/**
 * NOIZYFISH.COM — Holding Page
 * Platinum wordmark. 396 Hz universe. Coming soon.
 *
...
<title>NOIZYFISH — Coming Soon</title>
<meta name="description" content="NOIZYFISH. The sound is coming. A NOIZY Empire portal. 2026.">
...
.coming{
  ...
  color:rgba(0,212,255,.35);letter-spacing:.2em;margin-top:3rem;line-height:2;
  opacity:0;animation:fade 3s ease 3s forwards;
}
...
.foot{position:absolute;bottom:2rem;left:0;right:0;text-align:center;
  ...
  color:rgba(200,196,188,.15);opacity:0;animation:fade 2s ease 4.5s forwards;
}
