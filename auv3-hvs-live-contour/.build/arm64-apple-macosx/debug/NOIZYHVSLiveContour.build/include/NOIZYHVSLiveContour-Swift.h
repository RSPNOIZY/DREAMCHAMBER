...
#ifndef NOIZYHVSLIVECONTOUR_SWIFT_H
#define NOIZYHVSLIVECONTOUR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NOIZYHVSLiveContour",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19NOIZYHVSLiveContour18HVSBridgeAudioUnit") SWIFT_AVAILABILITY(ios,introduced=18.0) SWIFT_AVAILABILITY(macos,introduced=15.0)
@interface HVSBridgeAudioUnit : AUAudioUnit
