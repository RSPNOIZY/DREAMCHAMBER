...
```bash
cat ~/Desktop/HEAVEN/wrangler.toml
```
...
```bash
cd ~/Desktop/HEAVEN && npx wrangler rollback
```
...
2. `cat ~/Desktop/HEAVEN/wrangler.toml` — correct database IDs?
