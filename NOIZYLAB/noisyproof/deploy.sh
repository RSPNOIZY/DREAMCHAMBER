...
echo ""
echo "API Endpoints:"
echo "  POST https://proof.noisy.io/audio/register"
echo "  POST https://proof.noisy.io/consent/grant"
echo "  POST https://proof.noisy.io/consent/check"
echo "  GET  https://proof.noisy.io/provenance/:fingerprintId"
echo "  GET  https://proof.noisy.io/audit/verify"
echo "  GET  https://proof.noisy.io/audit/stats"
