...
export class ConsentEnforcementEngine {
  ...
  constructor(private db: D1Database) {
    this.audit = new ImmutableAuditLedger(db);
  }
  ...
  private async logConsentEvent(
    ...
    // Route through ImmutableAuditLedger to maintain hash chain integrity.
    // Direct INSERT to audit_log bypasses block_hash/previous_hash computation
    // and breaks verifyChainIntegrity().
