...
export class ImmutableAuditLedger {
   ...
   *
   * SACRED INVARIANT: audit_log is append-only.
   * UPDATE and DELETE are forbidden — enforced by database triggers.
   * See consent_audit_trail policy in CLAUDE.md.
   */
  async initialize(): Promise<void> {
    // Enforce append-only immutability with database triggers.
    // These triggers prevent any UPDATE or DELETE on the audit_log table.
